 ...
 */
public class CariPemasokView extends DialogView implements DocumentListener {
    ...
    public CariPemasokView(FormApp formApp) {
        super(formApp);
    ...
    private void jButtonPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPilihActionPerformed
        if (jDynamicTable.getSelectedRow() == -1) {
            ...
            pemasok = dynamicTableModel.get(jDynamicTable.convertRowIndexToModel(jDynamicTable.getSelectedRow()));
            dispose();
        }
    ...
    public Pemasok search(Window formApp) {
    ...
    public void display(Window formApp, Object parameter) {
        ...
        List<Pemasok> list = service.findAll();

        for (Pemasok value : list) {
