 ...
 */
public class TambahBarangPenjualanView extends DialogView implements DocumentListener {
    ...
    public TambahBarangPenjualanView(FormApp formApp) {
        super(formApp);
    ...
    private void initComponents() {
        ...
        jFormattedTextField1.setValue(new Long(1));
    ...
    private void jButtonPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPilihActionPerformed
        if (jDynamicTable.getSelectedRow() == -1) {
            ...
            DetailBarang detailBarang = dynamicTableModel.get(jDynamicTable.convertRowIndexToModel(jDynamicTable.getSelectedRow()));
            int jumlah = Integer.valueOf(jFormattedTextField1.getValue().toString());
            if (jumlah > detailBarang.getStok()) {
                messageComponent.showWarning("Jumlah stok tidak tersedia");
            } else {
                detailPenjualan = new DetailPenjualan();
                detailPenjualan.setDetailBarang(detailBarang);
    ...
    public DetailPenjualan search(Window formApp) {
    ...
    public void display(Window formApp, Object parameter) {
        ...
        List<DetailBarang> list = service.findAll();

        for (DetailBarang value : list) {
