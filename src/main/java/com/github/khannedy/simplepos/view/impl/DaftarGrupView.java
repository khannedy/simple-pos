 ...
 */
public class DaftarGrupView extends DialogView {

    private JDynamicTable jDynamicTable;
    private DynamicTableModel<Grup> dynamicTableModel;

    /**
     * Creates new form DaftarGrupView
     */
    public DaftarGrupView(FormApp formApp) {
        super(formApp);
        initComponents();

        dynamicTableModel = new DynamicTableModel<>(Grup.class);
    ...
    private void initComponents() {
        ...
        jButtonTambah.setText("Tambah Grup Baru");
        ...
        jButtonUbah.setText("Ubah Grup Terseleksi");
        ...
        jButtonHapus.setText("Hapus Grup Terseleksi");
    ...
    private void jButtonTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTambahActionPerformed
        TambahGrupView view = new TambahGrupView(getFormApp());
    ...
    private void jButtonUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUbahActionPerformed
        if (jDynamicTable.getSelectedRow() == -1) {
            ...
            Grup grup = dynamicTableModel.get(
                    jDynamicTable.convertRowIndexToModel(
                    jDynamicTable.getSelectedRow()));
            UbahGrupView view = new UbahGrupView(getFormApp());
            view.display(this, grup);
            resetTable();
        }
    ...
    private void jButtonHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHapusActionPerformed
        if (jDynamicTable.getSelectedRow() == -1) {
            ...
            Grup grup = dynamicTableModel.get(
                    jDynamicTable.convertRowIndexToModel(
                    jDynamicTable.getSelectedRow()));
            GrupService service = SpringManager.getInstance().
                    getBean(GrupService.class);
            try {
                service.remove(grup);
                resetTable();
