...
import com.github.khannedy.simplepos.validator.impl.PelangganValidator;
 ...
 */
public class UbahPelangganView extends DialogView {

    private Pelanggan pelanggan;

    /**
     * Creates new form TambahPelangganView
     */
    public UbahPelangganView(FormApp formApp) {
        super(formApp);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ubah Pelanggan");
    ...
    private void jButtonSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSimpanActionPerformed
        ...
        pelanggan.setNama(jTextFieldNama.getText());
        pelanggan.setAlamat(jTextAreaAlamat.getText());
        pelanggan.setTerakhirDirubah(new Date());
        pelanggan.setKota(jTextFieldKota.getText());
        pelanggan.setTelepon(jTextFieldTelepon.getText());
    ...
    public void display(Window formApp, Object parameter) {
        pelanggan = (Pelanggan) parameter;

        jTextAreaAlamat.setText(pelanggan.getAlamat());
        jTextFieldKode.setText(pelanggan.getId());
        jTextFieldKota.setText(pelanggan.getKota());
        jTextFieldNama.setText(pelanggan.getNama());
        jTextFieldTelepon.setText(pelanggan.getTelepon());
