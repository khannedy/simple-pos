 ...
 */
public class TambahBarangPembelianView extends DialogView implements DocumentListener {
    ...
    public TambahBarangPembelianView(FormApp formApp) {
        super(formApp);
    ...
    private void jButtonPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPilihActionPerformed
        if (jDynamicTable.getSelectedRow() == -1) {
            ...
            detailPembelian.setDetailBarang(detailBarang);
            detailPembelian.setJumlah(jumlah);
            dispose();
        }
    ...
    public DetailPembelian search(Window formApp) {
