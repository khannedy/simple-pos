...
import com.github.khannedy.simplepos.validator.impl.PenggunaValidator;
 ...
 */
public class UbahPenggunaView extends DialogView {
     ...
     */
    public UbahPenggunaView(FormApp formApp) {
        super(formApp);
        initComponents();
    }
    ...
    public void display(Window formApp, Object parameter) {
        this.pengguna = (Pengguna) parameter;
        ...
        jTextFieldKataSandi.setText(pengguna.getKataSandi());
        jTextFieldKode.setText(pengguna.getId());
        jComboBoxGrup.setSelectedItem(pengguna.getGrup());
        jCheckBoxAktif.setSelected(pengguna.isAktif());
