...
public class DaftarPenggunaView extends DialogView {
     ...
     */
    public DaftarPenggunaView(FormApp formApp) {
        super(formApp);
        initComponents();
    ...
    private void jButtonTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTambahActionPerformed
        TambahPenggunaView view = new TambahPenggunaView(getFormApp());
    ...
    private void jButtonUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUbahActionPerformed
        if (jDynamicTable.getSelectedRow() == -1) {
            ...
            Pengguna pengguna = dynamicTableModel.get(
                    jDynamicTable.convertRowIndexToModel(
                    jDynamicTable.getSelectedRow()));
            UbahPenggunaView view = new UbahPenggunaView(getFormApp());
            view.display(this, pengguna);
            resetTable();
        }
    ...
    private void jButtonHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHapusActionPerformed
        if (jDynamicTable.getSelectedRow() == -1) {
            ...
            Pengguna pengguna = dynamicTableModel.get(
                    jDynamicTable.convertRowIndexToModel(
                    jDynamicTable.getSelectedRow()));
            PenggunaService service = SpringManager.getInstance().
                    getBean(PenggunaService.class);
            try {
                service.remove(pengguna);
                resetTable();
    ...
    private void resetTable() {
        ...
        for (Pengguna pengguna : penggunaService.findAll()) {
