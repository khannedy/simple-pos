...
public class DaftarPenjualView extends DialogView {
    ...
    public void display(Window formApp, Object parameter) {
        ...
        jButtonHapus.setEnabled(grup.mengandungHakAkses(HakAksesConstant.HAPUS_PENJUAL));
        jButtonTambah.setEnabled(grup.mengandungHakAkses(HakAksesConstant.TAMBAH_PENJUAL));
        jButtonUbah.setEnabled(grup.mengandungHakAkses(HakAksesConstant.UBAH_PENJUAL));
