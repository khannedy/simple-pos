 ...
 */
public class UbahJabatanView extends DialogView {
     ...
     */
    public UbahJabatanView(FormApp formApp) {
        super(formApp);
        initComponents();
    }
    ...
    public void display(Window formApp, Object parameter) {
        jabatan = (Jabatan) parameter;

        jTextAreaInfo.setText(jabatan.getInfo());
        jTextFieldKode.setText(jabatan.getId());
        jTextFieldNama.setText(jabatan.getNama());
